...
1 2 1 2
500 10
82 785 37 785 34 785 102 785 15 157 64 785 93 785 24 157 76 785 102 785
1000 100
1 88 5 352 5 176 7 352 1 44 5 352 3 176 5 176 1 32 5 176 5 352 3 352 5 352 1 352 3 352 3 352 1 176 5 352 3 176 0 1 1 176 3 352 1 352 1 88 1 88 1 352 3 176 3 176 1 352 1 352 3 176 0 1 3 352 5 352 5 352 3 176 5 352 1 176 1 352 1 352 3 176 5 352 3 176 1 176 1 352 1 88 1 352 3 176 3 176 1 352 3 352 5 352 1 88 1 88 0 1 1 352 3 176 1 352 1 88 1 88 5 352 3 352 1 176 1 88 3 176 1 352 0 1 0 1 3 352 1 176 3 176 1 88 0 1 5 352 1 176 3 176 3 176 0 1 1 176 1 352 1 352 5 352 1 176 1 176 1 352 1 352 1 88 3 176 0 1 1 88 0 1 1 88 1 88 0 1 1 352 3 352 3 352 1 352 3 176 1 88
519 52
1 27 11 432 1 27 5 216 1 48 1 54 11 432 1 144 5 432 13 432 7 432 1 216 1 108 1 144 7 432 1 216 1 72 1 108 1 72 13 432 1 144 1 36 5 144 1 432 5 216 1 216 1 144 7 432 1 48 5 216 1 48 5 216 7 432 11 432 7 216 1 54 5 432 5 432 13 432 1 144 7 216 5 216 1 216 7 216 1 72 1 36 1 36 1 72 1 144 13 432 1 27 11 432
0 0
""")



r,n=[int(i) for i in stdin.readline().split()]
while(r!=0 and n!=0):
    case=1
    vals=[int(i) for i in stdin.readline().split()]
    prob=[]
    for i in range (len(vals)//2):
        prob.append(vals[i*2]/vals[i*2+1])
    pond=0
    r2=r
    c=1
    for i in range (len(prob)):
        while (r2*prob[i]<1 and prob[i]!=0):
            r2+=r2
        aux=prob[i]*r
        if aux > 1:
            aux=math.floor(prob[i]*r)
        pond+=aux
    sol=r2/pond
    print(f"{sol:.6f}")
    r,n=[int(i) for i in stdin.readline().split()]
